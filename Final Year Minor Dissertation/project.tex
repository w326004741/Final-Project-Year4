...
% %\emph{斜体}
% \bibitem{1}
% \emph{HuffPost UK. (2018). The 5 Best Music Apps That Won't Tear Through All Your Data. [online] Available at: https://www.huffingtonpost.com/2015/06/24/offline-music-apps_n_7649242.html [Accessed 10 Apr. 2018].}
% \bibitem{2}
% \emph{Rapid prototyping in the software development life cycle. [online] Available at: https://www.justinmind.com/blog/rapid-prototyping-isnt-helpful-or-is-it/.}
% \end{thebibliography}
\end{document}
